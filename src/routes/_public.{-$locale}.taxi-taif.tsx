...
const FAQ_AR = [
  { q: "هل توفرون توصيل من جدة أو مكة إلى الطائف؟", a: `نعم، نحن متخصصون في تقديم خدمة التوصيل المباشر من مطار الملك عبدالعزيز بجدة ومن فنادق مكة المكرمة إلى جميع مناطق الطائف بسعر يبدأ من ${getPriceForRoute('apt-jed-to-taif') || 'اطلب السعر'} (تواصل معنا للتأكيد).` },
