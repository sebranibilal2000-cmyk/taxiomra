...
const FAQ_EN = [
  ...
  { q: "Do you offer transfers between Makkah and Madinah?", a: `Yes, we offer direct and safe transfer services between the two Holy Mosques starting from ${getPriceForRoute('makkah-to-med')} SAR for a sedan.` },
